...
public enum Pelancongan_Package {
        ...
        Package_1(new Vector<>(List.of("Turki", "Istanbul")), "Ahmad Kamarul", 2500.00,
                new Vector<>(List.of(new Flight("D23", "14/6/2024", "20/6/2024", "0500","1300", "Istanbul International Airport", "KLIA"))),
        ...
        PACKAGE_2(new Vector<>(List.of("Riyadh", "Dammam")),"Badri Bakhtiar",3000.00,
                new Vector<>(List.of(new Flight("A12", "15/6/2024", "21/6/2024", "0600","1400", "King Khalid Internatiinal Airport", "KLIA"))),
        ...
        PACKAGE_3(new Vector<>(List.of("Doha", "Dubai")),"Aiman Hadi", 3500.00,
                new Vector<>(List.of(new Flight("B34", "16/6/2024", "22/6/2024", "0700","1500", "Hamad International Airport", "KLIA"))),
        ...
        PACKAGE_4(new Vector<>(List.of("Abu Dhabi", "Sharjah")),"Azhar Azfar",2800.00,
                new Vector<>(List.of(new Flight("C56", "17/6/2024", "23/6/2024", "0800","1600", "Zayed International Airport", "KLIA"))),
        ...
        PACKAGE_5(new Vector<>(List.of("Kuwait City", "Manama")),"Hafiz Haziq",4000.00,
                new Vector<>(List.of(new Flight("D78", "18/6/2024", "24/6/2024", "0900","1700", "Kuwait International Airport", "KLIA"))),
