        ...
        while (!validInput) {
            ...
            try {
                ...
                if (choice == 0 || choice == 1) {
                    ...
                    System.out.println("Invalid Choice! Please enter a valid number between [0/1].");
                }
                ...
                if (choice == 0) {
                    ...
                    while (!validResponse) {
                        ...
                        if (s.length() == 1 && (s.equalsIgnoreCase("y") || s.equalsIgnoreCase("n"))) {
                            char rs = s.toUpperCase().charAt(0);
                            if (rs == 'Y') {
                                stu = registerStudent();
                                StudList.add(stu);
...
private static Administrator signInAdministrator() {
    ...
    boolean authenticated = false; //try use this one
...
private static Student registerStudent() {
    try {
        ...
        return new Student(fname, lname, age, email, new Address(street, cityAndPostalCode, state), matricsNu);
...
public static Student signInStudent() {
    System.out.println("---------- Sign In ----------");
    System.out.print("ENTER YOUR USERNAME:\t");
    String us = inp.next();
    System.out.print("ENTER YOUR PASSWORD:\t");
