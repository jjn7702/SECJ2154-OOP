...
public class GroupProjectManager {
    ...
    System.out.println("Enter the project ID to edit: ");
    ...
    System.out.println("Editing Project: " + projectToEdit.getProjectID());
    System.out.println("1. Edit Project ID");
    System.out.println("2. Edit Project Name");
    System.out.println("3. Edit Project Description");
    ...
    switch (choice) {
        case 1:
            ...
            projectToEdit.setProjectID(input.nextLine());
            break;
        case 2:
        ...
        case 3:
            ...
            projectToEdit.setDescription(input.nextLine());
            break;
        default:
    ...
    // Edit Instructor
    Instructor instructor = projectToEdit.getInstructor();
    System.out.println("Editing Instructor: " + instructor.getName());
    System.out.println("1. Edit Instructor ID");
    System.out.println("2. Edit Instructor Name");
    System.out.println("3. Edit Instructor Department");
    System.out.println("4. Edit Instructor Email");
    ...
    switch (choice) {
        ...
        case 2:
            ...
            instructor.setName(input.nextLine());
            break;
        case 3:
            System.out.println("Enter new Instructor Department: ");
            instructor.setDepartment(input.nextLine());
            break;
        case 4:
            System.out.println("Enter new Instructor Email: ");
            instructor.setEmail(input.nextLine());
            break;
        default:
            System.out.println("Invalid choice.");
    }
    ...
    // Edit Team
    Team team = projectToEdit.getTeam();
    System.out.println("Editing Team: " + team.getTeamName());
    System.out.println("1. Edit Team Name");
    System.out.println("2. Edit Team Members");
    choice = input.nextInt();
    input.nextLine(); // Consume newline
    ...
    switch (choice) {
        case 1:
            ...
            break;
        case 2:
            System.out.println("Enter new Team Members (comma separated): ");
            String[] memberIds = input.nextLine().split(",");
            team.setMembers(new ArrayList<>(Arrays.asList(memberIds)));
            break;
        default:
            System.out.println("Invalid choice.");
    }
    ...
    // Edit Milestones
    ArrayList<Milestone> milestones = projectToEdit.getMilestones();
    System.out.println("Milestones: ");
    for (int i = 0; i < milestones.size(); i++) {
        System.out.println((i + 1) + ". " + milestones.get(i).getTitle());
    }
    System.out.println("Enter milestone number to edit or 0 to skip: ");
    int milestoneChoice = input.nextInt();
    input.nextLine(); // Consume newline

    if (milestoneChoice > 0 && milestoneChoice <= milestones.size()) {
        Milestone milestone = milestones.get(milestoneChoice - 1);
        System.out.println("Editing Milestone: " + milestone.getTitle());
        System.out.println("1. Edit Milestone Title");
        System.out.println("2. Edit Milestone Description");
        System.out.println("3. Edit Milestone Deadline");
        choice = input.nextInt();
        input.nextLine(); // Consume newline

        switch (choice) {
            case 1:
                System.out.println("Enter new Milestone Title: ");
                milestone.setTitle(input.nextLine());
                break;
            case 2:
                System.out.println("Enter new Milestone Description: ");
                milestone.setDescription(input.nextLine());
                break;
            case 3:
                System.out.println("Enter new Milestone Deadline: ");
                milestone.setDeadline(LocalDate.parse(input.nextLine()));
                break;
            default:
                System.out.println("Invalid choice.");
        }
    ...
    // Edit Tasks
    ArrayList<Task> tasks = projectToEdit.getTasks();
    System.out.println("Tasks: ");
    for (int i = 0; i < tasks.size(); i++) {
        System.out.println((i + 1) + ". " + tasks.get(i).getTitle());
    }
    System.out.println("Enter task number to edit or 0 to skip: ");
    ...
    if (taskChoice > 0 && taskChoice <= tasks.size()) {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                task.setDueDate(LocalDate.parse(input.nextLine()));
                break;
            default:
                System.out.println("Invalid choice.");
        }
    ...
    // Add/Edit Report
    Report report = projectToEdit.getReport();
    if (report == null) {
        System.out.println("No report found. Do you want to add a report? (yes/no): ");
        if (input.nextLine().equalsIgnoreCase("yes")) {
            ...
            report = new Report(reportID, reportTitle, reportContent);
            projectToEdit.setReport(report);
        }
    } else {
        System.out.println("Editing Report: " + report.getTitle());
        System.out.println("1. Edit Report Title");
        System.out.println("2. Edit Report Content");
        choice = input.nextInt();
        input.nextLine(); // Consume newline
        ...
        switch (choice) {
            case 1:
                ...
                report.setTitle(input.nextLine());
                break;
            case 2:
                System.out.println("Enter new Report Content: ");
                report.setContent(input.nextLine());
                break;
            default:
                System.out.println("Invalid choice.");
        }
    ...
    // Add/Edit Review
    if (report != null) {
        Review review = projectToEdit.getReview();
        if (review == null) {
            System.out.println("No review found. Do you want to add a review? (yes/no): ");
            if (input.nextLine().equalsIgnoreCase("yes")) {
                ...
                input.nextLine(); // Consume newline
                review = new Review(reviewID, reviewComment, reviewRating);
                projectToEdit.setReview(review);
            }
        } else {
            System.out.println("Editing Review: " + review.getReviewID());
            System.out.println("1. Edit Review Comment");
            System.out.println("2. Edit Review Rating");
            choice = input.nextInt();
            input.nextLine(); // Consume newline
            ...
            switch (choice) {
                case 1:
                    ...
                    review.setComment(input.nextLine());
                    break;
                case 2:
                    System.out.println("Enter new Review Rating: ");
                    review.setRating(input.nextInt());
                    input.nextLine(); // Consume newline
                    break;
                default:
                    System.out.println("Invalid choice.");
