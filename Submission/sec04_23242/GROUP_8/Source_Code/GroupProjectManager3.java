    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (!exit) {
                ...
                choice = inp.nextInt();
                inp.nextLine(); // Consume newline after reading choice
                ...
                switch (choice) {
                    case 1:
                        if (projects.size() > 0) {
                            ...
                            inp.nextLine(); // Consume newline after reading project ID
                            ...
                            for (Project proj : projects) {
                                if (proj.getProjectID() == selectedProjectId) {
                                    ...
                                    inp.nextLine(); // Consume newline after reading nested choice

                                    switch (nestedChoice) {
                                        case 1:
                                            System.out.println("\nEditing project with ID " + selectedProjectId);
                                            System.out.println("1) Edit Title\n2) Edit Description");
                                            System.out.print("Enter your choice :  ");
                                            int editChoice = inp.nextInt();
                                            inp.nextLine(); // Consume newline after reading edit choice
                                            ...
                                            switch (editChoice) {
                                                case 1:
                                                    ...
                                                    System.out.println("Title updated successfully: " + newTitle);
                                                    break;
                                                case 2:
                                                    System.out.print("Enter new description: ");
                                                    String newDescription = inp.nextLine();
                                                    proj.setDescription(newDescription);
                                                    System.out.println("Description updated successfully: " + newDescription);
                                                    break;
                                                default:
                                        ...
                                        case 3:
                                            System.out.println("\nEditing tasks for project with ID " + selectedProjectId);
                                            ...
                                            if (tasks.isEmpty()) {
                                                ...
                                                int taskIdToEdit = inp.nextInt();
                                                inp.nextLine(); // Consume newline after reading task ID

                                                boolean taskFound = false;
                                                for (Task task : tasks) {
                                                    if (task.getTaskID() == taskIdToEdit) {
                                                        taskFound = true;
                                                        ...
                                                        String newTaskStatus = inp.nextLine();
                                                ...
                                                if (!taskFound) {
                                                    System.out.println("Task with ID " + taskIdToEdit + " not found in the project.");
                                                }
                                            }
                                            break;
                                        ...
                                        default:
                                            System.out.println("Invalid choice for selected project action.");
                                            break;
                                    }
                    ...
                    case 2:
                        ...
                        inp.nextLine(); // Consume newline after reading number of members
                        ...
                        inp.nextLine(); // Consume newline after reading number of tasks
                        ...
                        inp.nextLine(); // Consume newline after reading number of reviews
                        ...
                        inp.nextLine(); // Consume newline after reading number of milestones

                        for (int i = 0; i < numMilestones; i++) {
                            System.out.print("Enter milestone ID: ");
                            int milestoneId = inp.nextInt();
                            inp.nextLine(); // Consume newline after reading milestone ID
                            ...
                            // You can handle milestones as needed

                            // Milestone milestone = new Milestone(milestoneId, milestoneDescription,
                            // milestoneDueDate);
